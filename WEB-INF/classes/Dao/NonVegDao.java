...
{
	public void retrieveCategory(NonVegi v)
	{
		int i=-1;
		final String driver="com.mysql.jdbc.Driver";
		final String DB_url="jdbc:mysql://localhost:3306/nonveginfo";
		...
		try{
			...
			String sql="select distinct category from nonveg";
	...
	public String retrieveItem(NonVegi v)
	{
		int i=-1;
		final String driver="com.mysql.jdbc.Driver";
		final String DB_url="jdbc:mysql://localhost:3306/nonveginfo";
